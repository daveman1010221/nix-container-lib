# nix-container-lib/nix/shell-fish.nix
#
# Fish shell environment assembly.
# Invoked by shell.nix when cfg.shell.shell == "/bin/fish".
# Do not call directly — use shell.nix.
#
